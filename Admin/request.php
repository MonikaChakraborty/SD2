...
<div class="col-sm-4 mb-5">
    ...
    if($result->num_rows > 0){
        ...
        echo '<div class="card mt-5 mx-5">';
         ...
         echo '<h5 class="class-title">Request Info: '.$row['request_info'];
         echo '</h5>';
...
if(isset($_REQUEST['assign'])){
    ...
    ($_REQUEST['inputdate']=="")){
        ...
        requester_add2, requester_city, requester_state, requester_zip, requester_email, requester_mobile, assign_tech,
        assign_date) VALUES ('$rid', '$rinfo', '$rdesc', '$rname', '$radd1', '$radd2', '$rcity', '$rstate', '$rzip',
...
<div class="col-sm-5 mt-5 jumbotron requestdesign"> <!-- Start Assigned Work 3rd Column -->
